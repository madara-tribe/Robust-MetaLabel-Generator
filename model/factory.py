...
def tts_ljspeech(step='95000', remote_path=None) -> Tuple[ForwardTransformer, dict]:
    if remote_path:
        ...
        model_path = 'model/bdf06b9_ljspeech_step_95000'
        model_path = Path(model_path).with_suffix('')
        return ForwardTransformer.load_model(model_path.as_posix())
